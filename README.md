...
[https://source.chromium.org/chromium/chromium/src/+/main:chrome/browser/themes/browser_theme_pack.cc](Link to file)

Which make every animated image decoded based on their first frame (converted to a [https://en.wikipedia.org/wiki/Bitmap](bitmap)) (*correct me if i'm wrong*)

(+ other part of the code that load only one time the bitmap which cannot create this dynamic effect)
---
Don't hesitate to correct me if I did something wrong !


Original repo : [https://github.com/nicoth-in/Dark-Space-Theme](Link to file)]
---
